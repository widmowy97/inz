...
$catalogue = new MessageCatalogue('bg', array (
  ...
  array (
    ...
    'exception.no_permission' => 'Нямате необходимите права, за да приложите това действие.',
    ...
    'security.list.hidden_results' => 'Някои резултати не могат да бъдат показани, защото нямате беобходимите права за това',
  ),
  'messages' => 
  array (
    ...
    'action.deselect' => 'Изчисти селекцията',
    'label.form.empty_value' => 'Без стойност',
