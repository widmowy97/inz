...
$catalogue = new MessageCatalogue('cs', array (
  ...
  array (
    ...
    'show.remaining_items' => '{1} existuje další položka nezobrazená v tomto seznamu|{2,3,4} %count% další položky nejsou zobrazeny v tomto seznamu|]5,Inf] %count% dalších položek není zobrazených v tomto seznamu',
    ...
    'exception.no_entities_configured' => 'Aplikace není korektně nakonfigurovaná.',
    'exception.undefined_entity' => 'Aplikace není korektně nakonfigurovaná pro tento typ položek.',
    'exception.no_permission' => 'Nemáte oprávnění k provedení této akce.',
    ...
    'security.list.hidden_results' => 'Některé výsledky nebohly být zobrazeny neboď nemáte patřičná oprávnění',
  ),
  'messages' => 
  array (
