...
class Patient extends \App\Entity\Patient implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'FirstName', '' . "\0" . 'App\\Entity\\Patient' . "\0" . 'LastName', 'id'];
        }
     ...
     * {@inheritDoc}
     */
    public function persist(\App\Entity\Patient $patient)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'persist', [$patient]);

        return parent::persist($patient);
    }
