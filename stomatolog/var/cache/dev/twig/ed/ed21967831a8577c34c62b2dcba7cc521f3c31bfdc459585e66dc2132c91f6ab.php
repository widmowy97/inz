...
class __TwigTemplate_03c546bc9dda931045141ef7d430360ac247a5e70ea1b878d840b6c512b88e77 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, ((array_key_exists("height", $context)) ? (_twig_default_filter((isset($context["height"]) || array_key_exists("height", $context) ? $context["height"] : (function () { throw new RuntimeError('Variable "height" does not exist.', 1, $this->source); })()), "24")) : ("24")), "html", null, true);
  ...
  <path
     ...
     fill=\"";
        // line 4
        echo twig_escape_filter($this->env, ((array_key_exists("fill_color", $context)) ? (_twig_default_filter((isset($context["fill_color"]) || array_key_exists("fill_color", $context) ? $context["fill_color"] : (function () { throw new RuntimeError('Variable "fill_color" does not exist.', 4, $this->source); })()), "#222")) : ("#222")), "html", null, true);
        echo "\" />
</svg>
";
...
", "@EasyAdmin/data_collector/icon.svg.twig", "C:\\projekt\\inz\\stomatolog\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\data_collector\\icon.svg.twig");
    }
}
