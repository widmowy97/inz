...
class __TwigTemplate_2b9990b0f159c5a578a40d0e720f183e4129148b75ed8bdfca4f56e5e0009dbd extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
            // line 4
            if ((1 === twig_compare(twig_length_filter($this->env, (isset($context["_flash_messages"]) || array_key_exists("_flash_messages", $context) ? $context["_flash_messages"] : (function () { throw new RuntimeError('Variable "_flash_messages" does not exist.', 4, $this->source); })())), 0))) {
                // line 5
    ...
    {% endif %}
{% endif %}
", "@EasyAdmin/default/flash_messages.html.twig", "C:\\projekt\\inz\\stomatolog\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\default\\flash_messages.html.twig");
    }
}
