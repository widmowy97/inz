...
class __TwigTemplate_164ee6f13a9b7a4d87e263b9ba60ec891aacecffb4b706d0c81b77872fe4dc57 extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 297, $this->source); })())]);
    ...
    public function block_form_rows($context, array $blocks = [])
    {
        ...
        // line 443
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_array_filter((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 443, $this->source); })()), function ($__child__) use ($context, $macros) { $context["child"] = $__child__; return  !twig_get_attribute($this->env, $this->source, $context["child"], "rendered", [], "any", false, false, false, 443); }));
        foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
            // line 444
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($context["child"], 'row');
        }
...
{% block attributes -%}
    ...
    {%- endfor -%}
{%- endblock attributes -%}
", "form_div_layout.html.twig", "C:\\projekt\\inz\\stomatolog\\vendor\\symfony\\twig-bridge\\Resources\\views\\Form\\form_div_layout.html.twig");
    }
}
